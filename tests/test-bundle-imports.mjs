...
function validateEncryptedData(encrypted, description) {
  ...
  const requiredFields = ['encryptedContent', 'cipherText', 'nonce', 'preset'];
...
async function runTests() {
  ...
  try {
    ...
    const clientPath = join(__dirname, 'dist/client/client.js');
    const serverPath = join(__dirname, 'dist/server/server.js');
    const corePath = join(__dirname, 'dist/core/core.js');
    const utilsPath = join(__dirname, 'dist/utils/utils.js');
