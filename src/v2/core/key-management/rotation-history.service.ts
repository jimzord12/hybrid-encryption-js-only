...
import { FileSystemError } from '../../../core/common/errors/interfaces/filesystem.interfaces';
import { isFSError } from '../../../core/common/guards/error.guards';
import { KeyPair } from '../../../core/common/interfaces/keys.interfaces';
import { KeyManagerConfig, RotationHistory, RotationHistoryEntry } from '../../../core/key-management/types/key-manager.types';
