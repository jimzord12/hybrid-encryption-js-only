...
import { KeyManagerConfig, KeyRotationState } from '../../../core/key-management/types/key-manager.types';
...
export class KeyRotationService {
  private readonly config: Pick<Required<KeyManagerConfig>, 'rotationGracePeriod' | 'preset' | 'enableFileBackup'>;
